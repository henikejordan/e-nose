 ...
 * @author usuario
 */
public final class EditarPoeira25 extends javax.swing.JFrame implements Editar {

    private static EditarPoeira25 instance = null;
    private final String[] opcInfo = {"Poeira 25 PM"};
    private final int[] opcIndices = {21};
    private String[] info;
    private int[] indices;
     ...
     */
    private EditarPoeira25() {
        initComponents();
        estadoAtual();
        preencheVetores();
    }

    public static EditarPoeira25 getInstance() {
        if (instance == null) {
            instance = new EditarPoeira25();
        }
        return instance;
    }
    ...
    private void initComponents() {
        ...
        jCheckBoxPoeira.setText("Poeira 25 PM");
